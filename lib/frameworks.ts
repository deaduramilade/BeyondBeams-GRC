...
export type FrameworkChangelogEntry = {
...
export const frameworkChangelog: FrameworkChangelogEntry[] = [
  {
    frameworkName: "ISO 27001",
    version: "2022 Annex A",
    releasedAt: "2022-10-25",
    summary: "Consolidated 114 controls from 2013 edition into 93 controls structured across 4 themes (Organisational, People, Physical, Technological) and introduced control attributes.",
    sourceAuthority: "International Organization for Standardization (ISO) / IEC JTC 1/SC 27",
  },
  {
    frameworkName: "NIST Cybersecurity Framework",
    version: "2.0",
    releasedAt: "2024-02-26",
    summary: "Expanded scope to all organisations regardless of sector or size, added the overarching 'Govern' (GV) function alongside Identify, Protect, Detect, Respond, and Recover.",
    sourceAuthority: "National Institute of Standards and Technology (NIST)",
  },
  {
    frameworkName: "SOC 2",
    version: "Trust Services Criteria 2017 (2022 Points of Focus)",
    releasedAt: "2022-11-01",
    summary: "Aligned common criteria with the 2013 COSO Internal Control Framework and updated points of focus for cloud security, configuration management, and vendor oversight.",
    sourceAuthority: "American Institute of CPAs (AICPA)",
  },
  {
    frameworkName: "Healthcare (HIPAA Security Rule)",
    version: "45 CFR Part 164 Subpart C",
    releasedAt: "2023-01-01",
    summary: "Administrative, physical, and technical safeguards for Electronic Protected Health Information (ePHI) with heightened business associate and ransomware resiliency requirements.",
    sourceAuthority: "U.S. Department of Health and Human Services (HHS)",
  },
  {
    frameworkName: "Fintech & Payments",
    version: "PCI DSS v4.0.1 / DORA / Common Controls",
    releasedAt: "2024-06-11",
    summary: "Comprehensive baseline combining PCI DSS 4.0.1 flexible targeted risk analysis with EU DORA ICT risk management and operational resilience standards.",
    sourceAuthority: "PCI Security Standards Council / European Union ESA",
  },
];
...
export const frameworkCatalog = [
  {
    name: "ISO 27001",
    version: "2022 Annex A",
    description: "Information security controls for an ISO/IEC 27001 ISMS.",
    industryTags: "ALL",
    sourceUrl: "https://www.iso.org/standard/27001",
    publicationDate: new Date("2022-10-25"),
    lastReviewedAt: new Date("2026-08-01"),
    contentOwner: "ISO/IEC JTC 1/SC 27 reference catalogue",
    applicability: "Use as a reference aid for an information security management system; confirm licensed text, scope, exclusions, and current edition with the organisation's compliance owner.",
    controls: [
  ...
  },
  {
    ...
    version: "2.0",
    description: "Outcome-based cybersecurity guidance organized around Govern, Identify, Protect, Detect, Respond and Recover.",
    industryTags: "ALL",
    sourceUrl: "https://www.nist.gov/cyberframework",
    publicationDate: new Date("2024-02-26"),
    lastReviewedAt: new Date("2026-08-01"),
    contentOwner: "NIST reference catalogue",
    applicability: "Use to structure cybersecurity outcomes and organisational context; it is not a certification or legal determination.",
    controls: [
  ...
  },
  {
    name: "SOC 2",
    version: "Trust Services Criteria 2017 (2022 Points of Focus)",
    description: "Controls aligned to the AICPA Trust Services Criteria for security, availability, processing integrity, confidentiality and privacy.",
    industryTags: "ALL",
    sourceUrl: "https://www.aicpa-cima.com/resources/landing/system-and-organization-controls-soc-suite-of-services",
    publicationDate: new Date("2022-11-01"),
    lastReviewedAt: new Date("2026-08-01"),
    contentOwner: "AICPA reference catalogue",
    applicability: "Use to organise control discussions for an assurance engagement; only an independent service auditor can issue a SOC report.",
    controls: [
  ...
  {
    name: "Healthcare (HIPAA Security Rule)",
    ...
    lastReviewedAt: new Date("2026-08-01"),
    contentOwner: "eCFR reference catalogue",
    applicability: "Confirm covered-entity/business-associate status and applicability with qualified privacy or legal counsel.",
    controls: [
      ...
      ["164.312(b)", "Audit controls", "Implement hardware, software and procedural mechanisms that record and examine activity.", "Technical"],
    ],
  },
  {
    name: "Fintech & Payments",
    version: "PCI DSS 4.0.1 / DORA / Common Controls",
    description: "Practical baseline for digital banks, wallets, crypto, stocks, forex and payment businesses.",
    industryTags: "FINTECH",
    sourceUrl: "https://www.pcisecuritystandards.org/document_library",
    publicationDate: new Date("2024-06-11"),
    lastReviewedAt: new Date("2026-08-01"),
    contentOwner: "PCI SSC / EU reference catalogue",
    applicability: "This combines reference controls from distinct regimes; determine which legal, contractual, supervisory, and card-brand obligations apply before relying on a control.",
    controls: [
...
export async function seedFrameworks() {
  for (const item of frameworkCatalog) {
    ...
    for (const [controlId, title, description, category] of item.controls) {
      await db.frameworkControl.upsert({
        where: { frameworkId_controlId: { frameworkId: framework.id, controlId } },
        update: { title, description, category },
        create: { frameworkId: framework.id, controlId, title, description, category },
      });
    }
  }
}
