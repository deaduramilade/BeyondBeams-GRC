...
export function RiskForm({ users, risk, references = [], controls = [], taxonomy = [], mappedControlIds = [] }: { users: { id: string; name: string }[]; risk?: EditableRisk; references?: Ref[]; controls?: FrameworkControlOption[]; taxonomy?: Taxonomy[]; mappedControlIds?: string[] }) {
