...
export default async function Roles() {
  ...
  return <><PageHeader eyebrow="Access governance" title="People and roles" description="Manage active members and tenant-scoped invitations with least-privilege roles."/><div className="space-y-5">
    {canInvite && <Card><CardHeader><div><h2 className="text-sm font-bold">Invite a team member</h2><p className="mt-1 text-xs text-muted-foreground">Invitations expire after seven days. Local links are logged to the server console.</p></div></CardHeader><CardContent><InviteMemberForm/></CardContent></Card>}
